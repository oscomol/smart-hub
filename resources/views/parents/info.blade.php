    ...
    <div class="mt-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="accordion" id="recordsAccordion2">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#recordsAccordion2">
                            <div class="card-body">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#recordsAccordion2">
                            <div class="card-body">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#recordsAccordion2">
                            <div class="card-body">
...
<script>
    function printStudentInfo() {
        // Show header and hide the print button
        document.getElementById('printHeader').style.display = 'block';
        document.getElementById('printButton').style.display = 'none';
        
        // Hide the accordion
        const accordion = document.getElementById('recordsAccordion2'); 
        if (accordion) {
